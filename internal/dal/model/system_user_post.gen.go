...
type SystemUserPost struct {
	...
	UserID    int64          `gorm:"column:user_id;type:bigint(20);not null;comment:用户ID" json:"userId"`                             // 用户ID
	PostID    int64          `gorm:"column:post_id;type:bigint(20);not null;comment:岗位ID" json:"postId"`                             // 岗位ID
