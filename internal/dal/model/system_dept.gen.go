...
type SystemDept struct {
	...
	ParentID     int64          `gorm:"column:parent_id;type:bigint;not null;comment:父部门id" json:"parentId"`                            // 父部门id
	Sort         int32          `gorm:"column:sort;type:int;not null;comment:显示顺序" json:"sort"`                                         // 显示顺序
	LeaderUserID *int64         `gorm:"column:leader_user_id;type:bigint;comment:负责人" json:"leaderUserId"`                              // 负责人
