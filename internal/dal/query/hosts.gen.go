...
func newHost(db *gorm.DB, opts ...gen.DOOption) host {
	...
	_host.ID = field.NewUint32(tableName, "id")
	_host.HostName = field.NewString(tableName, "host_name")
	_host.Address = field.NewString(tableName, "address")
	_host.HostPort = field.NewInt32(tableName, "host_port")
	_host.Username = field.NewString(tableName, "username")
	_host.HostPassword = field.NewString(tableName, "host_password")
	...
	_host.Remark = field.NewString(tableName, "remark")
...
type host struct {
	...
	HostName     field.String // 名称
	Address      field.String // ip地址
	HostPort     field.Int32  // 端口
	Username     field.String // 用户名
	HostPassword field.String // 密码
...
func (h *host) updateTableName(table string) *host {
	...
	h.HostName = field.NewString(table, "host_name")
	h.Address = field.NewString(table, "address")
	h.HostPort = field.NewInt32(table, "host_port")
	h.Username = field.NewString(table, "username")
	h.HostPassword = field.NewString(table, "host_password")
	...
	h.Remark = field.NewString(table, "remark")
...
func (h *host) fillFieldMap() {
	...
	h.fieldMap["id"] = h.ID
	h.fieldMap["host_name"] = h.HostName
	h.fieldMap["address"] = h.Address
	h.fieldMap["host_port"] = h.HostPort
	h.fieldMap["username"] = h.Username
	h.fieldMap["host_password"] = h.HostPassword
	h.fieldMap["created_at"] = h.CreatedAt
	h.fieldMap["updated_at"] = h.UpdatedAt
	h.fieldMap["deleted_at"] = h.DeletedAt
	h.fieldMap["remark"] = h.Remark
}
