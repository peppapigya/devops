...
func newSystemRoleMenu(db *gorm.DB, opts ...gen.DOOption) systemRoleMenu {
	...
	_systemRoleMenu.ID = field.NewInt64(tableName, "id")
	_systemRoleMenu.RoleID = field.NewInt64(tableName, "role_id")
	_systemRoleMenu.MenuID = field.NewInt64(tableName, "menu_id")
	_systemRoleMenu.Creator = field.NewString(tableName, "creator")
	_systemRoleMenu.CreateAt = field.NewTime(tableName, "create_at")
	_systemRoleMenu.Updater = field.NewString(tableName, "updater")
	_systemRoleMenu.UpdateAt = field.NewTime(tableName, "update_at")
